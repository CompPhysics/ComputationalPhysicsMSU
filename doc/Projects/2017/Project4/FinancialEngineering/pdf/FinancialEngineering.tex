...
\paragraph{Project 4a): Simulation of Transactions.}
...
\paragraph{Project 4b): Recognizing the distribution.}
Make thereafter a plot of  $\log{(w_m)}$ as function of $m$
  and see if you get a straight line.
  Comment the result.

\paragraph{Project 4c): Transactions and savings.}
...
\paragraph{Project 4d): Nearest neighbor interactions.}
...
\paragraph{Project 4e): Nearest neighbors and former  transactions.}
